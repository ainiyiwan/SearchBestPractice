package com.example.zy.searchbestpractice.notice;
...
import com.example.zy.searchbestpractice.BuildConfig;
import com.example.zy.searchbestpractice.base.BaseApplication;
import com.example.zy.searchbestpractice.bean.NoticeBean;
import com.example.zy.searchbestpractice.bean.base.ResultBean;
import com.example.zy.searchbestpractice.util.TLog;
...
//        }
    ...
    public static void publish(ResultBean resultBean, NoticeBean newNotice) {
        if (resultBean != null && resultBean.isOk() && newNotice != null) {
            ...
            NoticeServer.arrivedMsgAction(BaseApplication.context(), newNotice);
        }
    }
