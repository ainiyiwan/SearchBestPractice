package com.example.zy.searchbestpractice.bean;

import android.content.Context;

import com.example.zy.searchbestpractice.util.SharedPreferencesHelper;
...
public class NoticeBean implements Serializable {
    ...
    public NoticeBean set(NoticeBean bean) {
